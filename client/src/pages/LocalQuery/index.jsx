        ...
        <Table size="md">
          <Table.Head>
            <Table.Row>
              ...
              <Table.Header onClick={() => onSort('firstName')}>First Name</Table.Header>
              <Table.Header onClick={() => onSort('lastName')}>Last Name</Table.Header>
              <Table.Header onClick={() => onSort('email')}>Email</Table.Header>
              <Table.Header onClick={() => onSort('department')}>Department</Table.Header>
              <Table.Header onClick={() => onSort('jobTitle')}>Job Title</Table.Header>
            </Table.Row>
          </Table.Head>
          <Table.Body>
